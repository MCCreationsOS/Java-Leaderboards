...
function generateSubmissionFunctions(type, slug, message_text, formatting) {
    ...
    fs.writeFile("older_versions/data/mccreations/functions/leaderboards/submit/gen.mcfunction", `execute if score @s MCCreations.Leaderboards.Time matches 0..360000 run function mccreations:leaderboards/submit/gen/node`, () => {});
}
